...
public class SearchableListDialogOLD extends DialogFragment implements
    ...
    public SearchableListDialogOLD() {

    }

    public static SearchableListDialogOLD newInstance(List items) {
        SearchableListDialogOLD multiSelectExpandableFragment = new
                SearchableListDialogOLD();

...
public class ModeloPasajeros5 extends Form {
    ...
    private void iniciarTextosAeropuertos(){
        ...
        switch (idAeropuerto){
            ...
            case 13:
                ...
                activity.findViewById(R.id.survey_edit_text_cdlocacootro_GC).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_text_viene_re).setVisibility(GONE);
                activity.findViewById(R.id.survey_text_viene_re_TS).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_spinner_cdlocaco_prov).setVisibility(GONE);
                activity.findViewById(R.id.survey_spinner_cdlocaco_provGC).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_spinner_cdlocaco).setVisibility(GONE);
                activity.findViewById(R.id.survey_spinner_cdlocacoGC).setVisibility(VISIBLE);
                //P4 NO
                activity.findViewById(R.id.survey_radio_cdalojin_option10).setVisibility(GONE);
                //P5 NO
                //P6
            ...
            case 15:
                ...
                activity.findViewById(R.id.survey_edit_text_cdlocacootro_GC).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_text_viene_re).setVisibility(GONE);
                activity.findViewById(R.id.survey_text_viene_re_ACE).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_spinner_cdlocaco_prov).setVisibility(GONE);
                activity.findViewById(R.id.survey_spinner_cdlocaco_provGC).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_spinner_cdlocaco).setVisibility(GONE);
                activity.findViewById(R.id.survey_spinner_cdlocacoGC).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_radio_playa).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_radio_islas).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_radio_vienereotro_opcion3).setVisibility(GONE);
                //P4 NO
                ...
                //P21
                activity.findViewById(R.id.survey_text_vol12mes).setVisibility(GONE);
                activity.findViewById(R.id.survey_text_vol12mes_ACE).setVisibility(VISIBLE);
                //P22
                activity.findViewById(R.id.survey_text_p44factu).setVisibility(GONE);
                activity.findViewById(R.id.survey_text_p44factu_ACE).setVisibility(VISIBLE);
                //P23
                activity.findViewById(R.id.survey_text_nperbul).setVisibility(GONE);
                activity.findViewById(R.id.survey_text_nperbul_ACE).setVisibility(VISIBLE);
                //P24
                activity.findViewById(R.id.survey_text_chekinb).setVisibility(GONE);
            ...
            case 16:
                ...
                activity.findViewById(R.id.survey_edit_text_cdlocacootro_GC).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_text_viene_re).setVisibility(GONE);
                activity.findViewById(R.id.survey_text_viene_re_FUE).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_spinner_cdlocaco_prov).setVisibility(GONE);
                activity.findViewById(R.id.survey_spinner_cdlocaco_provGC).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_spinner_cdlocaco).setVisibility(GONE);
                activity.findViewById(R.id.survey_spinner_cdlocacoGC).setVisibility(VISIBLE);
            ...
            case 17:
                ...
                activity.findViewById(R.id.survey_edit_text_cdlocacootro).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_text_viene_re).setVisibility(GONE);
                activity.findViewById(R.id.survey_text_viene_re_LEI).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_spinner_cdlocaco_prov).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_spinner_cdlocaco).setVisibility(VISIBLE);
            ...
            case 18:
                ...
                activity.findViewById(R.id.survey_edit_text_cdlocacootro).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_text_viene_re).setVisibility(GONE);
                activity.findViewById(R.id.survey_text_viene_re_SDR).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_spinner_cdlocaco_prov).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_spinner_cdlocaco).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_radio_playa).setVisibility(GONE);
                activity.findViewById(R.id.survey_radio_islas).setVisibility(GONE);
            ...
            case 22:
                ...
                activity.findViewById(R.id.survey_edit_text_cdlocacootro).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_text_viene_re).setVisibility(GONE);
                activity.findViewById(R.id.survey_text_viene_re_GRO).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_spinner_cdlocaco_prov).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_spinner_cdlocaco).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_radio_playa).setVisibility(GONE);
                activity.findViewById(R.id.survey_radio_islas).setVisibility(GONE);
                ...
                activity.findViewById(R.id.survey_text_ultimodo_coche_vprivado_cvdespedir_m2).setVisibility(VISIBLE);
                ((TextView) activity.findViewById(R.id.survey_text_m4_ultimodo_conductor)).setText(R.string.survey_m4_text_ultimodo_coche_conductor_GRO);
                //P6
                activity.findViewById(R.id.survey_text_sitiopark).setVisibility(GONE);
                activity.findViewById(R.id.survey_text_sitiopark_m4).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_edit_text_pqfuera).setVisibility(GONE);
                ...
                activity.findViewById(R.id.survey_text_cdbillet).setVisibility(GONE);
                activity.findViewById(R.id.survey_text_cdbillet_ACE).setVisibility(VISIBLE);
                ((TextView) activity.findViewById(R.id.survey_radio_cdbillet_option4)).setText(R.string.survey_m4_radio_cdbillet_option4);
                //P20
                activity.findViewById(R.id.survey_text_nviaje).setVisibility(GONE);
                activity.findViewById(R.id.survey_text_nviaje_ACE).setVisibility(VISIBLE);
                //P21
                ...
                activity.findViewById(R.id.survey_text_cdslab).setVisibility(GONE);
                activity.findViewById(R.id.survey_text_cdslab_GC).setVisibility(VISIBLE);
                ((TextView) activity.findViewById(R.id.survey_radio_cdslab_option6)).setText(R.string.survey_m4_radio_cdslab_option6);
                //P28
                activity.findViewById(R.id.survey_text_cdsprof).setVisibility(GONE);
                activity.findViewById(R.id.survey_text_cdsprof_GC).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_radio_cdsprof_option6).setVisibility(GONE);
                ...
                //P31
                activity.findViewById(R.id.survey_text_cdsexo).setVisibility(GONE);
                activity.findViewById(R.id.survey_text_cdsexo_GRO).setVisibility(VISIBLE);
                //P32
                activity.findViewById(R.id.survey_text_valorexp).setVisibility(GONE);
                activity.findViewById(R.id.survey_text_valorexp_GRO).setVisibility(VISIBLE);
                break;
            case 23:
                //Jerez
                //P1
                ...
                activity.findViewById(R.id.survey_text_cdlocaco_prov).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_edit_text_cdlocacootro).setVisibility(VISIBLE);
                ((TextView) activity.findViewById(R.id.survey_text_viene_re)).setText(R.string.survey_m2_text_viene_re_XRY);
                activity.findViewById(R.id.survey_spinner_cdlocaco_prov).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_spinner_cdlocaco).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_radio_playa).setVisibility(GONE);
                activity.findViewById(R.id.survey_radio_islas).setVisibility(GONE);
    ...
    private void iniciarSpinners() {
        ...
        String filtroIsla = "03";
        ArrayList<mListString> islasAdapterACE = new ArrayList<mListString>(getDiccionario(Contracts.TABLE_TIPOGRANCANARIA,"iden", "codigo","descripcion", "codigo",filtroIsla));
        filtroIsla = "04";
        ArrayList<mListString> islasAdapterFUE = new ArrayList<mListString>(getDiccionario(Contracts.TABLE_TIPOGRANCANARIA,"iden", "codigo","descripcion", "codigo",filtroIsla));
        filtroIsla = "01";
        ArrayList<mListString> islasAdapterLP = new ArrayList<mListString>(getDiccionario(Contracts.TABLE_TIPOGRANCANARIA,"iden", "codigo","descripcion", "codigo",filtroIsla));
        ...
        switch (idAeropuerto){
            ...
            case 15:
                //Lanzarote
                filtroAeropuerto = " iden = 0 OR "+Contracts.COLUMN_TIPOCOMPANIAS_ACEOLEADA+"=1 ";
                break;
            case 16:
                //Fuerteventura
                filtroAeropuerto = " iden = 0 OR "+Contracts.COLUMN_TIPOCOMPANIAS_FUEOLEADA+"=1 ";
                break;
            case 17:
                //Almeria
                filtroAeropuerto = " iden = 0 OR "+Contracts.COLUMN_TIPOCOMPANIAS_LEIOLEADA+"=1 ";
                break;
            case 18:
                //Santander
        ...
        switch (idAeropuerto){
            ...
            case 13:
                //Tenerife sur
                filtroAeropuerto = " iden = 0 OR "+Contracts.COLUMN_TIPOCOMPANIAS_TFSAEREA+"=1 ";
                break;
            case 15:
                //Lanzarote
                filtroAeropuerto = " iden = 0 OR "+Contracts.COLUMN_TIPOCOMPANIAS_ACEAEREA+"=1 ";
                break;
            case 16:
                //Fuerteventura
                filtroAeropuerto = " iden = 0 OR "+Contracts.COLUMN_TIPOCOMPANIAS_FUEAEREA+"=1 ";
                break;
            case 17:
                //Almeria
                filtroAeropuerto = " iden = 0 OR "+Contracts.COLUMN_TIPOCOMPANIAS_LEIAEREA+"=1 ";
                break;
            case 18:
                //Santander
        ...
        switch (idAeropuerto){
            ...
            case 13:
                //Tenerife sur
                filtroAeropuerto = " "+Contracts.COLUMN_TIPOAEROPUERTOS_TFSOLEADA+" = 1";
                break;
            case 15:
                //Lanzarote
                filtroAeropuerto = " "+Contracts.COLUMN_TIPOAEROPUERTOS_ACEOLEADA+" = 1";
                break;
            case 16:
                //Fuerteventura
                filtroAeropuerto = " "+Contracts.COLUMN_TIPOAEROPUERTOS_FUEOLEADA+" = 1";
                break;
            case 17:
                //Almeria
                filtroAeropuerto = " "+Contracts.COLUMN_TIPOAEROPUERTOS_LEIOLEADA+" = 1";
                break;
            case 18:
                //Santander
        ...
        switch (idAeropuerto){
            ...
            case 13:
                //Tenerife sur
                filtroAeropuerto = " "+Contracts.COLUMN_TIPOAEROPUERTOS_TFSPRINCIPAL+" = 1";
                break;
            case 15:
                //Lanzarote
                filtroAeropuerto = " "+Contracts.COLUMN_TIPOAEROPUERTOS_ACEPRINCIPAL+" = 1";
                break;
            case 16:
                //Fuerteventura
            ...
            case 17:
                //Almeria
                filtroAeropuerto = " "+Contracts.COLUMN_TIPOAEROPUERTOS_LEIPRINCIPAL+" = 1";
                break;
            case 18:
                //Santander
        ...
        filtroAeropuerto = " iden IS NOT NULL "; //Para que salgan todos
        if (idAeropuerto == 22) {
            filtroAeropuerto = "iden IN (0, 8, 17, 25, 43, 22, 50, 53, 99)";
        }
...
//        }
        ...
        sp_cdlocaco_prov.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (idAeropuerto) {
                    case 22:
                        texto1 = " iden IS NOT NULL AND provincia NOT IN ('08','17','25','43','22','50','53','07','35','38')";
                        ...
                        break;
                    case 23:
                        texto1 = " iden IS NOT NULL AND provincia NOT IN ('06','10','11','14','21','23','41','54','56','07','35','38')";

                        if (texto.equals("06") || texto.equals("10") || texto.equals("11") || texto.equals("14") || texto.equals("21") || texto.equals("23") || texto.equals("41") || texto.equals("54") || texto.equals("56") || texto.equals("99")){
                            activity.findViewById(R.id.survey_text_cdlocaco).setVisibility(VISIBLE);
                            activity.findViewById(R.id.survey_spinner_cdlocaco).setVisibility(VISIBLE);
                            if (!texto.equals("99")) {
                                texto1 = " iden = 0 OR provincia = '"+texto+"'";
...
//                }
        ...
        sp_cdlocaco_prov_esp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                sp_cdlocaco_prov_esp.setBackgroundResource(android.R.drawable.btn_dropdown);
            }
            @Override
            public void onNothingSelected(AdapterView<?> parent) {
        ...
        SearchableSpinner sp_cdlocaco_provGC = (SearchableSpinner) activity.findViewById(R.id.survey_spinner_cdlocaco_provGC);
        ...
        SearchableSpinner sp_cdlocaco_provACE = (SearchableSpinner) activity.findViewById(R.id.survey_spinner_cdlocaco_provACE);
        sp_cdlocaco_provACE.setAdapter(islasAdapterACE, 1, 1, activity.getString(R.string.spinner_isla_title), activity.getString(R.string.spinner_close));

        sp_cdlocaco_provACE.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {

                sp_cdlocaco_provACE.setBackgroundResource(android.R.drawable.btn_dropdown);
            }
            @Override
            public void onNothingSelected(AdapterView<?> parent) {
        ...
        SearchableSpinner sp_cdlocaco_provFUE = (SearchableSpinner) activity.findViewById(R.id.survey_spinner_cdlocaco_provFUE);
        sp_cdlocaco_provFUE.setAdapter(islasAdapterFUE, 1, 1, activity.getString(R.string.spinner_isla_title), activity.getString(R.string.spinner_close));

        sp_cdlocaco_provFUE.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {

                sp_cdlocaco_provFUE.setBackgroundResource(android.R.drawable.btn_dropdown);
            }
            @Override
            public void onNothingSelected(AdapterView<?> parent) {
        ...
        SearchableSpinner sp_cdlocaco_provLP = (SearchableSpinner) activity.findViewById(R.id.survey_spinner_cdlocaco_provLP);
        sp_cdlocaco_provLP.setAdapter(islasAdapterLP, 1, 1, activity.getString(R.string.spinner_isla_title), activity.getString(R.string.spinner_close));

        sp_cdlocaco_provLP.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {

                sp_cdlocaco_provLP.setBackgroundResource(android.R.drawable.btn_dropdown);
            }
            @Override
            public void onNothingSelected(AdapterView<?> parent) {
        ...
        SearchableSpinner sp_cdlocacoGC = (SearchableSpinner) activity.findViewById(R.id.survey_spinner_cdlocacoGC);
        ...
        sp_cdpaisre.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (texto.equals("724")){ //España
                    ...
                    activity.findViewById(R.id.survey_radio_viene_re).setVisibility(GONE); //Añadido para controlar si en P2 reside en el extranjero que en P3 no aparezca vienere
        ...
        sp_cdlocado_prov.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (idAeropuerto){
                    ...
                    case 22:
                        //Girona
                        if((texto.equals("08"))||(texto.equals("17"))||(texto.equals("22"))||(texto.equals("25"))||(texto.equals("43"))||(texto.equals("50"))||(texto.equals("90"))){
                            activity.findViewById(R.id.survey_radio_viene_re).setVisibility(VISIBLE);
                        } else {
                            activity.findViewById(R.id.survey_radio_viene_re).setVisibility(GONE);
                        }
                    ...
                    case 26:
                        ...
                        break;
                    default:
                        if((texto.equals("07"))||(texto.equals("35"))||(texto.equals("94"))){
                            activity.findViewById(R.id.survey_radio_viene_re).setVisibility(GONE);
                        } else {
                            activity.findViewById(R.id.survey_radio_viene_re).setVisibility(VISIBLE);
                        }
...
/*
        ...
        switch (idAeropuerto){
            case 22:
                filtroAeropuerto = "iden IN (0, 08, 17, 25, 43, 22, 50, 53, 99)";
                break;
        }
        ArrayList<mListString> provinciasP3Adapter = new ArrayList<mListString>(getDiccionario(Contracts.TABLE_TIPOPROVINCIAS,"iden", "codigo","descripcion", "codigo", filtroAeropuerto));
        SearchableSpinner sp_cdlocaco_prov = (SearchableSpinner) activity.findViewById(R.id.survey_spinner_cdlocaco_prov);
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                switch (idAeropuerto) {
                    case 22:
                        ...
                        if (texto.equals("08") || texto.equals("17")|| texto.equals("25")|| texto.equals("43")|| texto.equals("22")|| texto.equals("50")|| texto.equals("53")){
                            texto1 = " iden = 0 OR provincia = '"+texto+"'";
                        }
                        break;
                }
...
// Sería substring 5 -> como en Modelo 4 case 10
        ...
        //P3 Filtro municipios
        final SearchableSpinner sp_cdlocaco_prov_esp = (SearchableSpinner) activity.findViewById(R.id.survey_spinner_cdlocaco_prov);
        ...
        sp_cdlocaco_prov_esp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                final SearchableSpinner sp_cdlocaco_esp= (SearchableSpinner) activity.findViewById(R.id.survey_spinner_cdlocaco);
                ArrayList<mListString> municipioAdapter= new ArrayList<mListString>(getDiccionario(Contracts.TABLE_TIPOMUNICIPIOS,"iden", "codigo","descripcion", "descripcion", filtro));
                sp_cdlocaco_esp.setAdapter(municipioAdapter, 1, 1, activity.getString(R.string.spinner_municipio_title), activity.getString(R.string.spinner_close));

                sp_cdlocaco_prov_esp.setBackgroundResource(android.R.drawable.btn_dropdown);
                String textoProv_esp = getValorDesplegable(sp_cdlocaco_prov_esp).substring(0,2);

                if ((textoProv_esp.equals("94"))){
        ...
        sp_cdlocaco_esp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                sp_cdlocaco_esp.setBackgroundResource(android.R.drawable.btn_dropdown);
                String texto5 = getValorDesplegable(sp_cdlocaco_esp).substring(0,5);
...
*/
                ...
                if (rbCdiaptoo.isChecked()) {
                    ...
                    switch (idAeropuerto) {
                        ...
                        case 13:
                            //Tenerife Sur
                            if (texto.equals("000")||(texto.equals("ZZZ"))) {
                                filtroAeropuerto1 = " " + Contracts.COLUMN_TIPOAEROPUERTOS_TFSPRINCIPAL + " = 1 ";
                            } else {
                                filtroAeropuerto1 = " " + Contracts.COLUMN_TIPOAEROPUERTOS_TFSPRINCIPAL + " = 1 AND " + Contracts.COLUMN_TIPOAEROPUERTOS_CODIGO + " NOT IN ('" + texto + "')";
                            }
                            break;
                        case 15:
                            //Lanzarote
                            /*if (texto.equals("000")||(texto.equals("ZZZ"))) {
                                filtroAeropuerto1 = " " + Contracts.COLUMN_TIPOAEROPUERTOS_ACEPRINCIPAL + " = 1 ";
                            } else {
                                filtroAeropuerto1 = " " + Contracts.COLUMN_TIPOAEROPUERTOS_ACEPRINCIPAL + " = 1 AND " + Contracts.COLUMN_TIPOAEROPUERTOS_CODIGO + " NOT IN ('" + texto + "')";
                            }*/
                            if (texto.equals("000")||(texto.equals("ZZZ"))) {
                                filtroAeropuerto1 = " " + Contracts.COLUMN_TIPOAEROPUERTOS_ACEPRINCIPAL + " = 1 ";
                            } else {
                        ...
                        case 17:
                            ...
                            if(textoCiudad.equals("")){
                                if (texto.equals("000")||(texto.equals("ZZZ"))) {
                                    filtroAeropuerto1 = " " + Contracts.COLUMN_TIPOAEROPUERTOS_LEIPRINCIPAL + " = 1 ";
                                } else {
                                    filtroAeropuerto1 = " " + Contracts.COLUMN_TIPOAEROPUERTOS_LEIPRINCIPAL + " = 1 AND " + Contracts.COLUMN_TIPOAEROPUERTOS_CODIGO + " NOT IN ('" + texto + "')";
                                }
                            }else{
                                if (texto.equals("000")||(texto.equals("ZZZ"))) {
                                    filtroAeropuerto1 = " " + Contracts.COLUMN_TIPOAEROPUERTOS_LEIPRINCIPAL + " = 1 ";
                                } else {
                                    filtroAeropuerto1 = " " + Contracts.COLUMN_TIPOAEROPUERTOS_LEIPRINCIPAL + " = 1 AND " + Contracts.COLUMN_TIPOAEROPUERTOS_CODIGO + " NOT IN ('" + texto + "') AND " + Contracts.COLUMN_TIPOAEROPUERTOS_CIUDAD + " NOT IN ('" + textoCiudad + "')";
                                }
                            }
                        ...
                        case 18:
                            ...
                            if(textoCiudad.equals("")){
                                if (texto.equals("000")||(texto.equals("ZZZ"))) {
                                    filtroAeropuerto1 = " " + Contracts.COLUMN_TIPOAEROPUERTOS_SDRPRINCIPAL + " = 1 ";
                                } else {
                                    filtroAeropuerto1 = " " + Contracts.COLUMN_TIPOAEROPUERTOS_SDRPRINCIPAL + " = 1 AND " + Contracts.COLUMN_TIPOAEROPUERTOS_CODIGO + " NOT IN ('" + texto + "')";
                                }
                            }else{
                                if (texto.equals("000")||(texto.equals("ZZZ"))) {
                                    filtroAeropuerto1 = " " + Contracts.COLUMN_TIPOAEROPUERTOS_SDRPRINCIPAL + " = 1 ";
                                } else {
                                    filtroAeropuerto1 = " " + Contracts.COLUMN_TIPOAEROPUERTOS_SDRPRINCIPAL + " = 1 AND " + Contracts.COLUMN_TIPOAEROPUERTOS_CODIGO + " NOT IN ('" + texto + "') AND " + Contracts.COLUMN_TIPOAEROPUERTOS_CIUDAD + " NOT IN ('" + textoCiudad + "')";
                                }
                            }
                        ...
                        case 23:
                            ...
                            if(textoCiudad.equals("")){
                                if (texto.equals("000")||(texto.equals("ZZZ"))) {
                                    filtroAeropuerto1 = " " + Contracts.COLUMN_TIPOAEROPUERTOS_XRYPRINCIPAL + " = 1 ";
                                } else {
                                    filtroAeropuerto1 = " " + Contracts.COLUMN_TIPOAEROPUERTOS_XRYPRINCIPAL + " = 1 AND " + Contracts.COLUMN_TIPOAEROPUERTOS_CODIGO + " NOT IN ('" + texto + "')";
                                }
                            }else{
                                if (texto.equals("000")||(texto.equals("ZZZ"))) {
                                    filtroAeropuerto1 = " " + Contracts.COLUMN_TIPOAEROPUERTOS_XRYPRINCIPAL + " = 1 ";
                                } else {
                                    filtroAeropuerto1 = " " + Contracts.COLUMN_TIPOAEROPUERTOS_XRYPRINCIPAL + " = 1 AND " + Contracts.COLUMN_TIPOAEROPUERTOS_CODIGO + " NOT IN ('" + texto + "') AND " + Contracts.COLUMN_TIPOAEROPUERTOS_CIUDAD + " NOT IN ('" + textoCiudad + "')";
                                }
                            }
                            break;
                        case 26:
        ...
        //P3 Filtro municipios GC
        final SearchableSpinner sp_cdlocaco_provGC = (SearchableSpinner) activity.findViewById(R.id.survey_spinner_cdlocaco_provGC);
        ...
        sp_cdlocaco_provGC.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                sp_cdlocaco_provGC.setBackgroundResource(android.R.drawable.btn_dropdown);
               String texto = getValorDesplegable(sp_cdlocaco_provGC).substring(0,2);

                final RadioButton rbVienereotroACE = (RadioButton) activity.findViewById(R.id.survey_radio_vienereotro_opcion1);
                if (rbVienereotroACE.isChecked()) {
                    texto = "03";
                }
                ...
                if (texto.equals("01")){
                    texto1 = " iden = 0 OR "+Contracts.COLUMN_TIPOISLASLOCALIDAD_CODIGOISLA+"= '"+texto+"'";
                } else if (texto.equals("02") || texto.equals("03")|| texto.equals("04")|| texto.equals("05")|| texto.equals("06")|| texto.equals("07")){
                    texto1 = " iden = 0 OR "+Contracts.COLUMN_TIPOISLASLOCALIDAD_CODIGOISLA+"= '"+texto+"'";
                }

                final SearchableSpinner sp_cdlocacoGC= (SearchableSpinner) activity.findViewById(R.id.survey_spinner_cdlocacoGC);
                ArrayList<mListString> islasLocalidadAdapterGC = new ArrayList<mListString>(getDiccionario(Contracts.TABLE_TIPOGRANCANARIALOCALIDAD,"iden", "codigo","descripcion", "codigo", texto1));
                sp_cdlocacoGC.setAdapter(islasLocalidadAdapterGC, 1, 1, activity.getString(R.string.spinner_localidad_title), activity.getString(R.string.spinner_close));
        ...
        final SearchableSpinner sp_cdlocaco_provACE = (SearchableSpinner) activity.findViewById(R.id.survey_spinner_cdlocaco_provACE);
        ...
        final SearchableSpinner sp_cdlocaco_provFUE = (SearchableSpinner) activity.findViewById(R.id.survey_spinner_cdlocaco_provFUE);
        ...
        final SearchableSpinner sp_cdlocaco_provLP = (SearchableSpinner) activity.findViewById(R.id.survey_spinner_cdlocaco_provLP);
        ...
        sp_cdlocacoGC.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                sp_cdlocacoGC.setBackgroundResource(android.R.drawable.btn_dropdown);
                String texto = getValorDesplegable(sp_cdlocacoGC).substring(0,5);

                if (texto.equals("OTROS")) {
                    activity.findViewById(R.id.survey_layout_playa).setVisibility(VISIBLE);
                    final SearchableSpinner sp_playa = (SearchableSpinner) activity.findViewById(R.id.survey_spinner_distracce);

                    sp_playa.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
                        @Override
                        public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {

                            sp_playa.setBackgroundResource(android.R.drawable.btn_dropdown);
                            String texto3 = getValorDesplegable(sp_playa).substring(0,5);

                            if (texto3.equals("99999")) {
                                activity.findViewById(R.id.survey_layout_playa).setVisibility(GONE);
                                activity.findViewById(R.id.survey_layout_cdlocacootro).setVisibility(VISIBLE);
                            } else {
                                activity.findViewById(R.id.survey_layout_playa).setVisibility(GONE);
                                blanquearEditText(activity.findViewById(R.id.survey_edit_cdlocacootro));
                ...
                switch (idAeropuerto) {
                    ...
                    case 13:
                        ...
                        if (texto1.equals("000") || (texto1.equals("ZZZ"))) {
                            ...
                            filtroAeropuerto1 = " " + Contracts.COLUMN_TIPOAEROPUERTOS_TFSPRINCIPAL + " = 1 AND " + Contracts.COLUMN_TIPOAEROPUERTOS_CODIGO + " NOT IN ('" + texto + "') AND " + Contracts.COLUMN_TIPOAEROPUERTOS_CODIGO + " NOT IN ('" + texto1 + "')";
                        }
                        break;
                    case 15:
                        //Lanzarote
                            /*if (texto1.equals("000")||(texto1.equals("ZZZ"))) {
                                ...
                                filtroAeropuerto1 = " "+Contracts.COLUMN_TIPOAEROPUERTOS_ACEPRINCIPAL+" = 1 AND "+Contracts.COLUMN_TIPOAEROPUERTOS_CODIGO+" NOT IN ('" + texto+"') AND "+Contracts.COLUMN_TIPOAEROPUERTOS_CODIGO+" NOT IN ('" + texto1+"')";
                            }*/
                        filtroAeropuerto1 = " " + Contracts.COLUMN_TIPOAEROPUERTOS_ACEPRINCIPAL + " = 1 ";
                        if (!(texto.equals("000") || (texto.equals("ZZZ")))) {
                            filtroAeropuerto1 = filtroAeropuerto1 + " AND " + Contracts.COLUMN_TIPOAEROPUERTOS_CODIGO + " NOT IN ('" + texto + "') ";
    ...
    private void condicionesRadioButton() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                switch(i)
                {
                    case R.id.survey_radio_cdlocaco:
                        switch (idAeropuerto){
                            case 4:case 6:
                                ...
                                activity.findViewById(R.id.survey_layout_cdplayaotro).setVisibility(GONE);
                                activity.findViewById(R.id.survey_layout_cdvieneotro).setVisibility(VISIBLE);
                                activity.findViewById(R.id.survey_layout_cdlocaco_prov).setVisibility(VISIBLE);
                                break;
                            case 13:
                                //Tenerife sur
                                activity.findViewById(R.id.survey_layout_cdiaptoo).setVisibility(GONE);
                                ...
                                activity.findViewById(R.id.survey_layout_cdplayaotro).setVisibility(GONE);
                                activity.findViewById(R.id.survey_layout_cdvieneotro).setVisibility(VISIBLE);
                                activity.findViewById(R.id.survey_layout_cdlocaco_prov).setVisibility(GONE);
                                activity.findViewById(R.id.survey_spinner_cdlocaco_provGC).setVisibility(VISIBLE);
                                break;
                            case 15:
                                //Lanzarote
                                ...
                                activity.findViewById(R.id.survey_text_viene_re_aviso_AGP).setVisibility(GONE);
                                activity.findViewById(R.id.survey_layout_cdplayaotro).setVisibility(GONE);
                                //activity.findViewById(R.id.survey_layout_cdvieneotro).setVisibility(GONE);
                                activity.findViewById(R.id.survey_spinner_cdlocaco_provACE).setVisibility(VISIBLE);
                                activity.findViewById(R.id.survey_spinner_cdlocaco_provFUE).setVisibility(GONE);
                                activity.findViewById(R.id.survey_spinner_cdlocaco_provLP).setVisibility(GONE);
                                activity.findViewById(R.id.survey_spinner_cdlocaco_provGC).setVisibility(GONE);
                                activity.findViewById(R.id.survey_layout_cdlocaco_prov).setVisibility(GONE);
                                activity.findViewById(R.id.survey_layout_cdvieneotro).setVisibility(GONE);
                                activity.findViewById(R.id.survey_text_cdlocaco).setVisibility(GONE);
                                activity.findViewById(R.id.survey_text_cdlocacoGC).setVisibility(VISIBLE);
                                String texto = "03";
                                ...
                                final SearchableSpinner sp_cdlocacoGC= (SearchableSpinner) activity.findViewById(R.id.survey_spinner_cdlocacoGC);
                                ArrayList<mListString> islasLocalidadAdapterGC = new ArrayList<mListString>(getDiccionario(Contracts.TABLE_TIPOGRANCANARIALOCALIDAD,"iden", "codigo","descripcion", "codigo", texto1));
                                sp_cdlocacoGC.setAdapter(islasLocalidadAdapterGC, 1, 1, activity.getString(R.string.spinner_municipio_title), activity.getString(R.string.spinner_close));
                                break;
                            case 16:
                                //Fuerteventura
                                activity.findViewById(R.id.survey_layout_cdlocaco).setVisibility(VISIBLE);
                                ...
                                activity.findViewById(R.id.survey_layout_cdplayaotro).setVisibility(GONE);
                                //activity.findViewById(R.id.survey_layout_cdvieneotro).setVisibility(GONE);
                                activity.findViewById(R.id.survey_spinner_cdlocaco_provACE).setVisibility(GONE);
                                activity.findViewById(R.id.survey_spinner_cdlocaco_provFUE).setVisibility(VISIBLE);
                                activity.findViewById(R.id.survey_spinner_cdlocaco_provLP).setVisibility(GONE);
                                activity.findViewById(R.id.survey_spinner_cdlocaco_provGC).setVisibility(GONE);
                                activity.findViewById(R.id.survey_layout_cdlocaco_prov).setVisibility(GONE);
                                activity.findViewById(R.id.survey_layout_cdvieneotro).setVisibility(GONE);
                                ...
                                final SearchableSpinner sp_cdlocacoGC16= (SearchableSpinner) activity.findViewById(R.id.survey_spinner_cdlocacoGC);
                                ArrayList<mListString> islasLocalidadAdapterGC16 = new ArrayList<mListString>(getDiccionario(Contracts.TABLE_TIPOGRANCANARIALOCALIDAD,"iden", "codigo","descripcion", "codigo", texto1));
                                sp_cdlocacoGC16.setAdapter(islasLocalidadAdapterGC16, 1, 1, activity.getString(R.string.spinner_municipio_title), activity.getString(R.string.spinner_close));
                                break;
                            case 17: case 18:
                                //Santander //Almeria
                                activity.findViewById(R.id.survey_layout_cdlocaco).setVisibility(VISIBLE);
                    ...
                    case R.id.survey_radio_cdiaptoo:
                        ...
                        activity.findViewById(R.id.survey_layout_cdvieneotro).setVisibility(GONE);
                        break;
                    case R.id.survey_radio_playa:
                        switch (idAeropuerto){
                            case 4:case 6:case 13: case 17: case 18:
                                activity.findViewById(R.id.survey_layout_cdiaptoo).setVisibility(GONE);
                                activity.findViewById(R.id.survey_layout_cdlocaco).setVisibility(GONE);
                                activity.findViewById(R.id.survey_layout_cdiaptoootro_m4).setVisibility(GONE);
                                activity.findViewById(R.id.survey_text_viene_re_aviso_AGP).setVisibility(GONE);
                            ...
                            case 15: case 16:
                                ...
                                activity.findViewById(R.id.survey_layout_cdiaptoootro_m4).setVisibility(GONE);
                                activity.findViewById(R.id.survey_text_viene_re_aviso_AGP).setVisibility(GONE);
                                activity.findViewById(R.id.survey_layout_cdplayaotro).setVisibility(VISIBLE);
                                activity.findViewById(R.id.survey_layout_cdvieneotro).setVisibility(GONE);
                                break;
                        }
                        break;
        ...
        RadioGroup rgVienereotro = (RadioGroup) activity.findViewById(R.id.survey_radiogroup_vienereotro);
        rgVienereotro.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                rgVienereotro.setBackgroundColor(activity.getResources().getColor(R.color.aenaDarkGrey));
                switch(i)
                {
                    case R.id.survey_radio_vienereotro_opcion1:
                        activity.findViewById(R.id.survey_layout_cdlocaco).setVisibility(VISIBLE);
                        //activity.findViewById(R.id.survey_text_cdlocaco).setVisibility(GONE);
                        activity.findViewById(R.id.survey_layout_cdlocaco_prov).setVisibility(GONE);
                        activity.findViewById(R.id.survey_spinner_cdlocaco_provFUE).setVisibility(VISIBLE);
                        ...
                        //activity.findViewById(R.id.survey_layout_cdlocaco_prov).setVisibility(GONE);
                        break;
                    case R.id.survey_radio_vienereotro_opcion2:
                        activity.findViewById(R.id.survey_layout_cdlocaco).setVisibility(VISIBLE);
                        //activity.findViewById(R.id.survey_text_cdlocaco).setVisibility(GONE);
                        activity.findViewById(R.id.survey_layout_cdlocaco_prov).setVisibility(GONE);
                        activity.findViewById(R.id.survey_spinner_cdlocaco_provFUE).setVisibility(GONE);
                        activity.findViewById(R.id.survey_spinner_cdlocaco_provACE).setVisibility(GONE);
                        activity.findViewById(R.id.survey_spinner_cdlocaco_provLP).setVisibility(VISIBLE);
                        activity.findViewById(R.id.survey_spinner_cdlocaco_provGC).setVisibility(GONE);
                        //activity.findViewById(R.id.survey_layout_cdlocaco_prov).setVisibility(GONE);
                        activity.findViewById(R.id.survey_text_cdlocaco).setVisibility(GONE);
                        activity.findViewById(R.id.survey_text_cdlocacoGC).setVisibility(VISIBLE);
                        ...
                        String texto3 = " iden IS NOT NULL ";

                        if (texto2.equals("01")){
                            texto3 = " iden = 0 OR "+Contracts.COLUMN_TIPOISLASLOCALIDAD_CODIGOISLA+"= '"+texto2+"'";
                        } else if (texto2.equals("02") || texto2.equals("03")|| texto2.equals("04")|| texto2.equals("05")|| texto2.equals("06")|| texto2.equals("07")){
                            texto3 = " iden = 0 OR "+Contracts.COLUMN_TIPOISLASLOCALIDAD_CODIGOISLA+"= '"+texto2+"'";
                        }

                        final SearchableSpinner sp_cdlocacoGC1= (SearchableSpinner) activity.findViewById(R.id.survey_spinner_cdlocacoGC);
                        ArrayList<mListString> islasLocalidadAdapterGC1 = new ArrayList<mListString>(getDiccionario(Contracts.TABLE_TIPOGRANCANARIALOCALIDAD,"iden", "codigo","descripcion", "codigo", texto3));
                        sp_cdlocacoGC1.setAdapter(islasLocalidadAdapterGC1, 1, 1, activity.getString(R.string.spinner_municipio_title), activity.getString(R.string.spinner_close));
                        break;
                    case R.id.survey_radio_vienereotro_opcion3:
                        activity.findViewById(R.id.survey_layout_cdlocaco).setVisibility(VISIBLE);
                        //activity.findViewById(R.id.survey_text_cdlocaco).setVisibility(GONE);
                        activity.findViewById(R.id.survey_layout_cdlocaco_prov).setVisibility(GONE);
                        activity.findViewById(R.id.survey_spinner_cdlocaco_provFUE).setVisibility(GONE);
                        ...
                        final SearchableSpinner sp_cdlocacoGC2= (SearchableSpinner) activity.findViewById(R.id.survey_spinner_cdlocacoGC);
                        ArrayList<mListString> islasLocalidadAdapterGC2 = new ArrayList<mListString>(getDiccionario(Contracts.TABLE_TIPOGRANCANARIALOCALIDAD,"iden", "codigo","descripcion", "codigo", texto3));
                        sp_cdlocacoGC2.setAdapter(islasLocalidadAdapterGC2, 1, 1, activity.getString(R.string.spinner_municipio_title), activity.getString(R.string.spinner_close));
                        break;
                }
            }
        });
        ...
        RadioGroup rgUmodosGC = (RadioGroup) activity.findViewById(R.id.survey_radiogroup_GC_ultimodo_1modo);
        rgUmodosGC.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                rgUmodosGC.setBackgroundColor(activity.getResources().getColor(R.color.md_blue_grey_200));
                switch(i)
                {
                    case R.id.survey_radio_GC_ultimodo_1modo_option8:
                        activity.findViewById(R.id.survey_edit_GC_ultimodo_otros).setVisibility(VISIBLE);
                        break;
                    default:
                        activity.findViewById(R.id.survey_edit_GC_ultimodo_otros).setVisibility(View.INVISIBLE);
                        break;
                }
            }
        });
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                switch(i)
                {
                    case R.id.survey_radio_cdidavue_option1:
                        ...
                        switch (idAeropuerto){
                            case 4: case 6: case 13: case 17: case 18:
                                //Ibiza //Menorca //Tenerife sur //Almeria //Santander
                                activity.findViewById(R.id.survey_text_cdidavue_a_m4).setVisibility(VISIBLE);
            ...
            case 5:
                ...
                switch (idAeropuerto) {
                    ...
                    case 15: case 16:
                        ...
                        LinearLayout p51 = (LinearLayout) activity.findViewById(R.id.survey_GC_layout_ultimod);
                        previo.setVisibility(VISIBLE);
                        save.setVisibility(VISIBLE);
                        next.setVisibility(VISIBLE);
        ...
        if (activated) {
            switch (check) {
                ...
                case 3:
                    ...
                    /*if(!requeridoRadioGroup(activity.findViewById(R.id.survey_radiogroup_vienereotro))){
                        return false;
                    }*/

                    if((activity.findViewById(R.id.survey_layout_cdvieneotro).getVisibility()==VISIBLE)){
                        if(!requeridoRadioGroup(activity.findViewById(R.id.survey_radiogroup_vienereotro))){
                            return false;
                        }
                    }

                    if((activity.findViewById(R.id.survey_layout_cdlocaco).getVisibility()==VISIBLE)&&(activity.findViewById(R.id.survey_spinner_cdlocaco).getVisibility()==VISIBLE)){
                        final SearchableSpinner sp_cdlocaco = (SearchableSpinner) activity.findViewById(R.id.survey_spinner_cdlocaco);
                    ...
                    if((activity.findViewById(R.id.survey_layout_cdlocaco).getVisibility()==VISIBLE)&&(activity.findViewById(R.id.survey_spinner_cdlocacoGC).getVisibility()==VISIBLE)){
                        final SearchableSpinner sp_cdlocacoGC = (SearchableSpinner) activity.findViewById(R.id.survey_spinner_cdlocacoGC);

                        if (getValorDesplegable(sp_cdlocacoGC).substring(0,4).equals("0000")) {
                            sp_cdlocacoGC.setBackgroundColor(activity.getResources().getColor(R.color.aenaRed));
                    ...
                    if (activity.findViewById(R.id.survey_layout_cdplayaotro).getVisibility() == VISIBLE) {
                        EditText etCdplaya = (EditText) activity.findViewById(R.id.survey_edit_cdplayaotro);
                        if (etCdplaya.getText().toString().isEmpty()) {
                            String textoError = activity.getResources().getString(R.string.survey_text_selectOption2);
                            etCdplaya.setBackgroundColor(activity.getResources().getColor(R.color.aenaRed));
                            etCdplaya.setError(textoError);
                            return getDialogValueBackError(activity,
                                    activity.getResources().getString(R.string.survey_model_text_errorTitle),
                                    textoError,
                                    activity.getResources().getString(R.string.survey_model_text_errorBtnReview));
                        } else {
                            etCdplaya.setBackgroundColor(activity.getResources().getColor(R.color.md_white_1000));
                        }
                    }
                    ...
                    RadioGroup rgVieneres = (RadioGroup) activity.findViewById(R.id.survey_radiogroup_viene_re_diaptoo);
                    /*final SearchableSpinner sp_cdlocado = (SearchableSpinner) activity.findViewById(R.id.survey_spinner_cdlocado);
                    sp_cdlocado.setBackgroundResource(android.R.drawable.btn_dropdown);
                    activity.findViewById(R.id.survey_radio_viene_re).setVisibility(VISIBLE);
                    String texto = getValorDesplegable(sp_cdlocado).substring(0,5);

                   / if ((rgVieneres.getCheckedRadioButtonId()==R.id.survey_radio_viene_re) && ((texto.equals("35004"))||(texto.equals("35010"))||(texto.equals("35018"))||(texto.equals("35024"))||(texto.equals("35028"))||(texto.equals("35029"))||(texto.equals("35034")))) {
                    ...
                    final RadioButton rbVienereACE = (RadioButton) activity.findViewById(R.id.survey_radio_viene_re);
                    if (rbVienereACE.isChecked()) {
                        final SearchableSpinner sp_cdlocado = (SearchableSpinner) activity.findViewById(R.id.survey_spinner_cdlocado);
                        sp_cdlocado.setBackgroundResource(android.R.drawable.btn_dropdown);
                        ...
                        switch (idAeropuerto){
                            ...
                            case 15:
                                //Lanzarote
                                if (((texto.equals("35004")) || (texto.equals("35010")) || (texto.equals("35018")) || (texto.equals("35024")) || (texto.equals("35028")) || (texto.equals("35029")) || (texto.equals("35034")))) {
                                }else{
                                    String textoError = activity.getResources().getString(R.string.survey_text_selectOption1);
                                    return getDialogValueBackError(activity,
                                            activity.getResources().getString(R.string.survey_model_text_errorTitle),
                            ...
                            case 16:
                                //Fuerteventura
                                if (((texto.equals("35003")) || (texto.equals("35007")) || (texto.equals("35014")) || (texto.equals("35015")) || (texto.equals("35017")) || (texto.equals("35030")))) {
                                }else{
                                    String textoError = activity.getResources().getString(R.string.survey_text_selectOption1);
                                    return getDialogValueBackError(activity,
                                            activity.getResources().getString(R.string.survey_model_text_errorTitle),
                            ...
                            case 22:
                                ...
                                if (!(texto_pais.equals("724"))) {
                                    ...
                                    if (((texto_prov.equals("08")) || (texto_prov.equals("17")) || (texto_prov.equals("25")) || (texto_prov.equals("43")) || (texto_prov.equals("22")) || (texto_prov.equals("50")) ||  (texto_prov.equals("90")))) {
                            ...
                            case 23:
                                ...
                                if (!(texto_pais.equals("724"))) {
                                    ...
                                    if (((texto_prov.equals("06")) || (texto_prov.equals("10")) || (texto_prov.equals("11")) || (texto_prov.equals("14")) || (texto_prov.equals("21")) || (texto_prov.equals("23")) ||  (texto_prov.equals("41")) || (texto_prov.equals("91")) || (texto_prov.equals("93")))) {
                ...
                case 5:
                    ...
                    switch (idAeropuerto) {
                        ...
                        case 15: case 16:
                            //Lanzarote y Fuerteventura
                            RadioGroup rgUltimodoGC= (RadioGroup) activity.findViewById(R.id.survey_radiogroup_GC_ultimodo_1modo);

                            if(!requeridoRadioGroup(activity.findViewById(R.id.survey_radiogroup_GC_ultimodo_1modo))){
                                return false;
                            }

                            if (rgUltimodoGC.getCheckedRadioButtonId() == R.id.survey_radio_GC_ultimodo_1modo_option8){
                                EditText etUltimodoGC = (EditText) activity.findViewById(R.id.survey_edit_GC_ultimodo_otros);
                                if (etUltimodoGC.getText().toString().isEmpty()){
                                    String textoError = activity.getResources().getString(R.string.survey_text_specifyAnswer);
                                    etUltimodoGC.setBackgroundColor(activity.getResources().getColor(R.color.aenaRed));
                                    etUltimodoGC.setError(textoError);
                                    return getDialogValueBackError(activity,
                                            activity.getResources().getString(R.string.survey_model_text_errorTitle),
                                            textoError,
                                            activity.getResources().getString(R.string.survey_model_text_errorBtnReview));
                                } else {
                                    etUltimodoGC.setBackgroundColor(activity.getResources().getColor(R.color.md_white_1000));
                                }
                            }
                            break;
                    }
        ...
        if (activated) {
            switch (check) {
                ...
                case 3:
                    ...
                    guardaDB(Contracts.COLUMN_CUEPASAJEROS_PLAYA, cue.getPlaya());
        ...
        if (activated) {
            switch (check) {
                ...
                case 3:
                    ...
                    borraDB(Contracts.COLUMN_CUEPASAJEROS_PLAYA);
    ...
    public void hideQuestions() {
        ...
        LinearLayout ultimomodoGC = (LinearLayout) activity.findViewById(R.id.survey_GC_layout_ultimod);
        ultimomodoGC.setVisibility(GONE);
            ...
            case 5:
                ...
                switch (idAeropuerto) {
                    ...
                    case 15: case 16:
                        //Lanzarote y Fuerteventura
                        if (activated) {
                            RadioGroup rgUltimodo_umodo= (RadioGroup) activity.findViewById(R.id.survey_radiogroup_GC_ultimodo_1modo);
                            checkedId = rgUltimodo_umodo.getCheckedRadioButtonId();
                            if ((checkedId == R.id.survey_radio_GC_ultimodo_1modo_option4) || (checkedId == R.id.survey_radio_GC_ultimodo_1modo_option5)) {
                                show = showQuestion(6);//>P6
                            } else{
                                show = showQuestion(7);//>P7
                            }
            ...
            case 22:
                ...
                /*if (activated) {
                    ...
                    if (checkedId > 0) {
                        switch (checkedId) {
                            case R.id.survey_radio_npers_option1:
                                show = showQuestion(25); //>P24
                                break;
                        }
                    } else {
                        show = showQuestion(24); //>P23
                    }
                } else {
                    show = showQuestion(24); //>P23
                }*
...
//        }
        ...
        String textSpCdlocaco1 = getValorDesplegable(sp_cdlocaco).substring(0,5);
        SearchableSpinner sp_cdlocacoGC = (SearchableSpinner) activity.findViewById(R.id.survey_spinner_cdlocacoGC);
        String textSpCdlocacoGC = getValorDesplegable(sp_cdlocacoGC).substring(0,4);
        String textSpCdlocaco1GC = getValorDesplegable(sp_cdlocacoGC).substring(0,5);
        SearchableSpinner sp_playa = (SearchableSpinner) activity.findViewById(R.id.survey_spinner_distracce);
        String textPlaya = getValorDesplegable(sp_playa).substring(0,5);
            ...
            switch (checkedId) {
                ...
                case R.id.survey_radio_cdlocaco:
                    switch (idAeropuerto){
                        ...
                        case 13: case 15: case 16:
                            //Tenerife
                            if(!textSpCdlocaco1GC.contains("00000")){
                                quest.setCdlocaco(textSpCdlocaco1GC);
                                quest.setDistracce("-1");
                                quest.setPlaya("-1");
                                //quest.setCdiaptoo("-1");
                                quest.setCdiaptoo("-1");
                        ...
                        case 17: case 18: case 22: case 23: case 9: case 26:
                            ...
                            if(!textSpCdlocaco.contains("00000")){
                                ...
                                quest.setCdiaptoo("-1");
                                quest.setCdiaptoootro("-1");
                                if (textSpCdlocaco.contains("99999")){
                                    EditText et_cdlocacootro = (EditText) activity.findViewById(R.id.survey_edit_cdlocacootro);
                                    quest.setCdlocacootro(et_cdlocacootro.getText().toString());
                                    quest.setDistracce("-1");
                                    quest.setPlaya("-1");
                                    ...
                                    quest.setCdiaptoootro("-1");
                                    //quest.setCdiaptoo("-1");
                                } else if (textSpCdlocaco.contains("OTROS")){
                                    quest.setDistracce(textPlaya);
                                    quest.setPlaya("-1");
                                    quest.setCdiaptoo("-1");
                                    quest.setCdiaptoootro("-1");
                    ...
                    break;
                case R.id.survey_radio_playa:
                    EditText etPlayaotro= (EditText) activity.findViewById(R.id.survey_edit_cdplayaotro);
                ...
                case R.id.survey_radio_islas:
                    ...
                    checkedId = rgVieneres.getCheckedRadioButtonId();
                    if (checkedId > 0) {
                        switch (checkedId) {
                            case R.id.survey_radio_vienereotro_opcion1:
                                quest.setDistracce("1");
                                break;
                            case R.id.survey_radio_vienereotro_opcion2:
                                quest.setDistracce("2");
                                break;
                            case R.id.survey_radio_vienereotro_opcion3:
                                quest.setDistracce("3");
                                break;
                        }
                    }
                    break;
        ...
        if (checkedId > 0) {
            switch (checkedId) {
                ...
                case R.id.survey_radio_cdalojin_option10:
                    ...
                    selectedCode = 10;
                    break;
                case R.id.survey_radio_cdalojin_option3:
                    quest.setCdalojin_otros("-1");
                    selectedCode = 3;
                    break;
                case R.id.survey_radio_cdalojin_option9:
        ...
        switch (idAeropuerto) {
            ...
            case 15: case 16:
                //Lanzarote y Fuerteventura
                RadioGroup rgUltimodo_umodoGC= (RadioGroup) activity.findViewById(R.id.survey_radiogroup_GC_ultimodo_1modo);

                selectedCode = -1;
                checkedId = rgUltimodo_umodoGC.getCheckedRadioButtonId();
                ...
                if (checkedId > 0) {
                    switch (checkedId) {
                        ...
                        case R.id.survey_radio_GC_ultimodo_1modo_option7:
                            ...
                            break;
                        case R.id.survey_radio_GC_ultimodo_1modo_option8:
                            EditText etUltimodo_otrosGC= (EditText) activity.findViewById(R.id.survey_edit_GC_ultimodo_otros);
                            quest.setUltimodootro(etUltimodo_otrosGC.getText().toString());
                            selectedCode = 91;
                            break;
                        default:
                            selectedCode = 0;
        ...
        if (checkedId > 0) {
            switch (checkedId) {
                case R.id.survey_radio_cdbillet_option1:
                    selectedCode = 1;
                    break;
                case R.id.survey_radio_cdbillet_option3:
                    selectedCode = 3;
                    break;
        ...
        if (checkedId > 0) {
            switch (checkedId) {
                ...
                case R.id.survey_radio_cdsprof_option9:
                    selectedCode = 9;
                    break;
                case R.id.survey_radio_cdsprof_option11:
                    selectedCode = 11;
                    break;
                default:
                    selectedCode = 99;
    ...
    private void generarTituloCdalojin() {
        switch (idAeropuerto){
            ...
            case 16: case 15:
                ...
                SearchableSpinner sp_cdlocacoGC = (SearchableSpinner) activity.findViewById(R.id.survey_spinner_cdlocacoGC);
                //String textSpCdlocaco = sp_cdlocaco.getSelectedItem().toString();
                String textSpCdlocacoGC = getValorDesplegable(sp_cdlocacoGC);
                String textoCdalojinGC = activity.getString(R.string.survey_m4_text_cdalojin);
                TextView tvCdalojinGC = (TextView) activity.findViewById(R.id.survey_text_cdalojin_crucero);
                if (textSpCdlocacoGC.length()>6)
                    textSpCdlocacoGC = textSpCdlocacoGC.substring(6, textSpCdlocacoGC.length());
                tvCdalojinGC.setText(textoCdalojinGC.replace("%1$s", textSpCdlocacoGC));
                break;
        }
    }

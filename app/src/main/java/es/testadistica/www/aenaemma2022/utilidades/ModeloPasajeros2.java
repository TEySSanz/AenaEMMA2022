...
public class ModeloPasajeros2 extends Form {
    ...
    public ModeloPasajeros2(Activity surveyAct, int pregunta, DBHelper conn) {
    ...
    private void iniciarTextosAeropuertos(){
        ...
        switch (idAeropuerto){
            case 5:
                ...
                //P3
                activity.findViewById(R.id.survey_text_cdcambio).setVisibility(GONE);
                activity.findViewById(R.id.survey_text_cdcambio_m2).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_radio_cdcambio_option1).setVisibility(GONE);
                activity.findViewById(R.id.survey_radio_cdcambio_option1_m2).setVisibility(VISIBLE);
                activity.findViewById(R.id.survey_radio_cdcambio_option2).setVisibility(GONE);
                activity.findViewById(R.id.survey_radio_cdcambio_option2_m2).setVisibility(VISIBLE);
                //P4
                ...
                activity.findViewById(R.id.survey_text_eleccovid_m2).setVisibility(VISIBLE);
                //P27
                activity.findViewById(R.id.survey_text_p44factu).setVisibility(GONE);
                activity.findViewById(R.id.survey_text_p44factu_m2).setVisibility(VISIBLE);
                //P28
    ...
    public int showQuestion(int show) {
        ...
        switch (show) {
            ...
            case 26:
                //P26
                LinearLayout p26 = (LinearLayout) activity.findViewById(R.id.survey_layout_eleccovid);
                previo.setVisibility(VISIBLE);
                save.setVisibility(VISIBLE);
                next.setVisibility(VISIBLE);
            ...
            case 27:
                //P27
                LinearLayout p27  = (LinearLayout) activity.findViewById(R.id.survey_layout_p44factu);
                previo.setVisibility(VISIBLE);
                save.setVisibility(VISIBLE);
                next.setVisibility(VISIBLE);
            ...
            case 28:
                //P28
                LinearLayout p28 = (LinearLayout) activity.findViewById(R.id.survey_layout_nperbul);
                previo.setVisibility(VISIBLE);
                save.setVisibility(VISIBLE);
                next.setVisibility(VISIBLE);
        ...
        switch (show) {
            ...
            case 3:
                ...
                if (activated) {
                    ...
                    if (checkedId > 0) {
                        switch (checkedId) {
                            case R.id.survey_radio_cdcambio_option1_m2:
                                show = showQuestion(4); //>P4
                                break;
                            case R.id.survey_radio_cdcambio_option2_m2:

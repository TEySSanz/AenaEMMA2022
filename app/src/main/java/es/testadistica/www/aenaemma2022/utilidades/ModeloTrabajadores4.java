...
public class ModeloTrabajadores4 extends FormTrab {

    private static final String TAG = "ModeloTrabajadores4";
    ...
    public ModeloTrabajadores4(Activity surveyAct, int pregunta, DBHelper conn) {
    ...
    public int getLayoutId() {
        return R.layout.form_modeltrabajadores4;
    }
    ...
    private void iniciarTextosAeropuertos(){
        ...
        switch (cue.getIdAeropuerto()){
            case 8:
                ...
                //P7
                activity.findViewById(R.id.survey_text_nmodos).setVisibility(GONE);
                ...
                activity.findViewById(R.id.survey_text_nocucoche_AGP).setVisibility(VISIBLE);

                //P10
                activity.findViewById(R.id.survey_text_satistranspubli).setVisibility(GONE);
                activity.findViewById(R.id.survey_text_satistranspubli_AGP).setVisibility(VISIBLE);

                //P11
                activity.findViewById(R.id.survey_text_valtranspubli).setVisibility(GONE);
                activity.findViewById(R.id.survey_text_valtranspubli_AGP).setVisibility(VISIBLE);

                //P12
                activity.findViewById(R.id.survey_text_mejtranspubli).setVisibility(GONE);
                activity.findViewById(R.id.survey_text_mejtranspubli_AGP).setVisibility(VISIBLE);

                //P13
                activity.findViewById(R.id.survey_text_desplazatrab).setVisibility(GONE);
                activity.findViewById(R.id.survey_text_desplazatrab_AGP).setVisibility(VISIBLE);

                //P14
                activity.findViewById(R.id.survey_text_aparctrab).setVisibility(GONE);
                activity.findViewById(R.id.survey_text_aparctrab_AGP).setVisibility(VISIBLE);
    ...
    private void condicionesRadioButton() {
        ...
        //P15
        final RadioGroup rgVelecaerop= (RadioGroup) activity.findViewById(R.id.survey_radiogroup_velecaerop);
        final RadioButton rbVelecaerop_1 = (RadioButton) activity.findViewById(R.id.survey_radio_velecaerop_option1);
        final RadioButton rbVelecaerop_2 = (RadioButton) activity.findViewById(R.id.survey_radio_velecaerop_option2);
        final RadioButton rbVelecaerop_3 = (RadioButton) activity.findViewById(R.id.survey_radio_velecaerop_option3);

        rbVelecaerop_1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                rgVelecaerop.setBackgroundColor(activity.getResources().getColor(R.color.aenaDarkGrey));
            }
        });

        rbVelecaerop_2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                rgVelecaerop.setBackgroundColor(activity.getResources().getColor(R.color.aenaDarkGrey));
            }
        ...
        rbVelecaerop_3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                rgVelecaerop.setBackgroundColor(activity.getResources().getColor(R.color.aenaDarkGrey));
            }
    ...
    public int showQuestion(int show) {
        ...
        switch (show) {
            ...
            case 6:
                //P6
                LinearLayout p6 = (LinearLayout) activity.findViewById(R.id.survey_layout_horaent_pregunta);
                previo.setVisibility(VISIBLE);
                save.setVisibility(VISIBLE);
                next.setVisibility(VISIBLE);
            ...
            case 7:
                //P7
                LinearLayout p7 = (LinearLayout) activity.findViewById(R.id.survey_layout_nmodos);
                previo.setVisibility(VISIBLE);
                save.setVisibility(VISIBLE);
                next.setVisibility(VISIBLE);
            ...
            case 8:
                //P8
                LinearLayout p8 = (LinearLayout) activity.findViewById(R.id.survey_layout_ultimodo_pregunta);
                previo.setVisibility(VISIBLE);
                save.setVisibility(VISIBLE);
                next.setVisibility(VISIBLE);
            ...
            case 9:
                //P9
                LinearLayout p9 = (LinearLayout) activity.findViewById(R.id.survey_layout_nocucoche);
                previo.setVisibility(VISIBLE);
                save.setVisibility(VISIBLE);
                next.setVisibility(VISIBLE);
            ...
            case 10:
                //P10
                LinearLayout p10 = (LinearLayout) activity.findViewById(R.id.survey_layout_satistranspubli);
                previo.setVisibility(VISIBLE);
                save.setVisibility(VISIBLE);
                next.setVisibility(VISIBLE);
            ...
            case 11:
                //P11
                LinearLayout p11 = (LinearLayout) activity.findViewById(R.id.survey_layout_valtranspubli);
                previo.setVisibility(VISIBLE);
                save.setVisibility(VISIBLE);
                next.setVisibility(VISIBLE);
            ...
            case 12:
                //P12
                LinearLayout p12 = (LinearLayout) activity.findViewById(R.id.survey_layout_mejtranspubli);
                previo.setVisibility(VISIBLE);
                save.setVisibility(VISIBLE);
                next.setVisibility(VISIBLE);
            ...
            case 13:
                //P13
                LinearLayout p13 = (LinearLayout) activity.findViewById(R.id.survey_layout_desplazatrab);
                previo.setVisibility(VISIBLE);
                save.setVisibility(VISIBLE);
                next.setVisibility(VISIBLE);
            ...
            case 14:
                //P14
                LinearLayout p14 = (LinearLayout) activity.findViewById(R.id.survey_layout_aparctrab);
                previo.setVisibility(VISIBLE);
                save.setVisibility(VISIBLE);
                next.setVisibility(VISIBLE);
            ...
            case 15:
                //P15
                RelativeLayout p15 = (RelativeLayout) activity.findViewById(R.id.survey_layout_velecaerop);
                previo.setVisibility(VISIBLE);
                save.setVisibility(VISIBLE);
                next.setVisibility(VISIBLE);
        ...
        if (activated) {
            switch (check) {
                ...
                case 15:
                    ...
                    if (!rbVelecaerop_1.isChecked() && !rbVelecaerop_2.isChecked() && !rbVelecaerop_3.isChecked()) {
                        rgVelecaerop.setBackgroundColor(activity.getResources().getColor(R.color.aenaRed));
    ...
    public boolean saveQuestion(int check) {
        ...
        if (activated) {
            switch (check) {
                ...
                case 15:
                    //P15
                    guardaDB(Contracts.COLUMN_CUETRABAJADORES_VELECAEROP, cue.getVelecaerop());
    ...
    private boolean checkDelete(int check) {
        ...
        if (activated) {
            switch (check) {
                ...
                case 15:
                    //P15
                    borraDB(Contracts.COLUMN_CUETRABAJADORES_VELECAEROP);
    ...
    public CueTrabajadores fillQuest(CueTrabajadores quest) {
        ...
        //P15
        RadioGroup rgVelecaerop = (RadioGroup) activity.findViewById(R.id.survey_radiogroup_velecaerop);

        selectedCode = -1;
        checkedId = rgVelecaerop.getCheckedRadioButtonId();

        if (checkedId > 0) {
            switch (checkedId) {
                case R.id.survey_radio_velecaerop_option1:
                    selectedCode = 1;
                    break;
                case R.id.survey_radio_velecaerop_option2:
                    selectedCode = 2;
                    break;
                case R.id.survey_radio_velecaerop_option3:
                    selectedCode = 3;
                    break;
                default:
                    selectedCode = 9;
        ...
        quest.setVelecaerop(String.valueOf(selectedCode));
